...
import { TextField, Button, MenuItem, Select, InputLabel, FormControl, Box, Grid, IconButton, Typography, FormHelperText, } from "@mui/material";
import { useFormik } from "formik";
import * as Yup from "yup";
import Visibility from "@mui/icons-material/Visibility";
import VisibilityOff from "@mui/icons-material/VisibilityOff";
...
const RegisterForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      axiosInstance.post("https://blissboutiq-backend.onrender.com/api/user/register", values)
        .then((response) => {
          alert("Account created successfully");
        })
        .catch((err) => {
          console.error("Error response:", err.response?.data || err.message);
          alert("Error occurred: " + (err.response?.data?.message || err.message));
        });
