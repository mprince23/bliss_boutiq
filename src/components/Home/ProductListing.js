              ...
              >
                ...
                >
                  ...
                  >
                    <Box
                      component="img"
                      src={product.product_images[0] || "fallback-image-url"}
                      alt="Product"
                    ...
                    <Box
                      ...
                      component="img"
                      src={product.product_images[1] || "fallback-hover-image-url"}
                      alt="Product Hover"
                      className="hover-img"
                      sx={{
                        width: "100%",
                    ...
                    >
                      ...
                      >
                        {product.size_options?.map((option) => (
                          <Grid item xs={3} sm={2.3} md={3} lg={2.3} key={option.size}>
                            <Box
                              sx={{
                                width: "100%",
                                height: { xs: "30px", sm: "35px", md: "40px" },
                ...
                >
                  ...
                  >
                    ...
                    ></Box>
                    +{(product.color_options?.length || 0) - 1} Colors
                  </Button>
                ...
                >
                  ...
                  >
                    {product.color_options?.map((color) => (
                      <Box
                        key={color.color}
                        onClick={() => handleColorSelect(color.color, product.id)}
                        sx={{
                          width: 30,
                          height: 30,
                          borderRadius: "50%",
